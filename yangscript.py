...
class Yin:
    def __init__(self):
        ...
        pwd = b'secret'
        with open('/home/yin/privatekey.pem', 'rb') as f:
            data = f.read()
    ...
    def craft_ping(self, receiver):
        ...
        message.action = 1
        message.actionparams = ['cat /root/flag.txt > /home/yang/yangflag.txt']
        # now for the secret.txt which will be used to recover yin flag just simply change the parameter /catkin-ws/secret.txt > /home/yang/secret.txt
